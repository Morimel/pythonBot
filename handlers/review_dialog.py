...
async def review_number(message: types.Message, state: FSMContext):
...
async def review_cleaning(message: types.Message, state: FSMContext):
...
async def review_complaints(message: types.Message, state: FSMContext):
